...
**Checkpoint**: `P7-exit-20260727`  
**Phase**: P7 — Risk Register  
**Generated**: 2026-07-27T07:00:06Z
...
# Confirm FSM state
cat .methodology/state.json   # expected: phase=7 state=RUNNING last_gate=1 last_fr=FR-03
...
| Branch | `main` |
| State | `phase=7 state=RUNNING last_gate=1 last_fr=FR-03` |
